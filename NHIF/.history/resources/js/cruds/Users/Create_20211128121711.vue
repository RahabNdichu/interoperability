              ...
              <div class="row">
                <div class="col-md-12">
                  <div
                    ...
                    :class="{
                      'has-items': entry.firstname,
                      'is-focused': activeField == 'firstname'
                    }"
                  >
                    <label class="bmd-label-floating required">FirstName</label>
                    <input
                      class="form-control"
                      type="text"
                      :value="entry.firstname"
                      @input="updateFirstName"
                      @focus="focusField('firstname')"
                      @blur="clearFocus"
                      required
                    />
                  </div>
                   ...
                   <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.lastname,
                      'is-focused': activeField == 'lastname'
                    }"
                  >
                    <label class="bmd-label-floating required">LastName</label>
                    <input
                      class="form-control"
                      type="text"
                      :value="entry.lastname"
                      @input="updateLastName"
                      @focus="focusField('lastname')"
                      @blur="clearFocus"
                      required
                    />
                  </div>
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.id_no,
                      'is-focused': activeField == 'id_no'
                    }"
                  >
                    <label class="bmd-label-floating required">ID </label>
                    <input
                      class="form-control"
                      type="text"
                      :value="entry.lastname"
