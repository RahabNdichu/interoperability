...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::resource('kpa-applications', 'KpaApplicationsController');
      ...
      // kpa Applications
      Route::delete('nssf-applications/destroy', 'NSSFApplicationsController@massDestroy')->name('nssf-applications.massDestroy');
      Route::resource('nssf-applications', 'nssfApplicationsController');
