...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // nhif
    Route::delete('nhif/destroy', 'NHIFApplicationsController@massDestroy')->name('nhif-applications.massDestroy');
    Route::resource('nhif', 'NHIFApplicationsController');

    // kpb
    Route::delete('kpb/destroy', 'kpbApplicationsController@massDestroy')->name('kpb-applications.massDestroy');
    Route::resource('kpb', 'NHIFApplicationsController');
