...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::resource('kpa-applications', 'KpaApplicationsController');
      ...
      // kpa Applications
      Route::delete('nss-applications/destroy', 'nssApplicationsController@massDestroy')->name('nss-applications.massDestroy');
      Route::resource('nss-applications', 'nssApplicationsController');
