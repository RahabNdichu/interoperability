<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('status_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.nssf.index") }}" class="c-sidebar-nav-link {{ request()->is('admin/statuses') || request()->is('admin/statuses/*') ? 'active' : '' }}">
        ...
        @can('nssf_access')
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.statuses.index") }}" class="c-sidebar-nav-link {{ request()->is('admin/nssf') || request()->is('admin/nssf/*') ? 'active' : '' }}">
                <i class="fa-fw fas fa-check c-sidebar-nav-icon">
