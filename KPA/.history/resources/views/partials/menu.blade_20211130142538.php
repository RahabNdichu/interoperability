<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <div class="c-sidebar-brand d-md-down-none">
        <a class="c-sidebar-brand-full h4" href="{{ route("admin.kpa-applications.index") }}">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('nssf_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.nssf.index") }}" class="c-sidebar-nav-link {{ request()->is('admin/nssf') || request()->is('admin/nssf/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-check c-sidebar-nav-icon"></i>
                    {{ trans('cruds.nssf.title') }}
                    </a>
            </li>
        @endcan
        @can('nhif_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.nhif.index") }}" class="c-sidebar-nav-link {{ request()->is('admin/nhif') || request()->is('admin/nhif/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-check c-sidebar-nav-icon"></i>
                    {{ trans('cruds.nhif.title') }}
                    </a>
            </li>
        @endcan
        @can('kpb_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.kpb.index") }}" class="c-sidebar-nav-link {{ request()->is('admin/kpb') || request()->is('admin/kpb/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-check c-sidebar-nav-icon"></i>
                    {{ trans('cruds.kpb.title') }}
                </a>
            </li>
        @endcan
