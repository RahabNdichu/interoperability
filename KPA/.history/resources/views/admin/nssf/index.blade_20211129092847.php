                        ...
                        <tr data-entry-id="{{ $nssf->id }}">
                            ...
                            <td>
                                ...
                                @can('nssf_application_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.nssf-applications.show', $nssf->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
{{--
                                ...
                                @can('nssf_application_delete')
                                    <form action="{{ route('admin.nssf-applications.destroy', $nssf->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
