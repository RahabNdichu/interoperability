  ...
  data() {
    return {
      columns: [
        ...
        { title: 'FirstName', field: 'firstname', sortable: true },
        { title: 'LastName', field: 'lastname', sortable: true },
        { title: 'ID Number', field: 'id_no', sortable: true },
        { title: 'Member Number', field: 'member_no', sortable: true },
